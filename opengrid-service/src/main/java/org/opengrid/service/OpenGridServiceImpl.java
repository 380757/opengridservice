...
public class OpenGridServiceImpl implements OpenGridService {
	...
	public String getOpenGridDatasetsList() {
		...
		try {
			...
			FileReader fr1 = new FileReader("c:/temp/Wheather.json");
	
	        pojo1 = (JsonObject) PojoMapper.fromJson(fr1, JsonObject.class);
	        
	        FileReader fr2 = new FileReader("c:/temp/Twitter.json");
	
	        pojo2 = (JsonObject) PojoMapper.fromJson(fr2, JsonObject.class);
	...
	public String getOpenGridOneDataset(String datasetId) {
		...
		if (datasetId.equalsIgnoreCase("Twitter")) {
			try {
		          ...
		          pojo = (JsonObject) PojoMapper.fromJson(fr, JsonObject.class);
		...
		else if (datasetId.equalsIgnoreCase("Wheather")) {
			try {
		          FileReader fr = new FileReader("c:/temp/Wheather.json");
		          pojo = (JsonObject) PojoMapper.fromJson(fr, JsonObject.class);
